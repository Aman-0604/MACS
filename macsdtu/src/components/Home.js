      ...
      <div className="join-page w-full">
        ...
        <div className="text-center p-2 m-1">
          ...
          <div className="flex justify-center">
            <Link className="flex gap-1 items-center stylish-2 border rounded p-1 m-2 text-sm md:text-lg hover:bg-white items-center" to='https://www.instagram.com/macs_dtu/' target='_blank' rel="noreferrer"><span className='bg-transparent'>Instagram</span>
            ...
            <Link className="flex gap-1 items-center stylish-2 border rounded p-1 m-2 text-sm md:text-lg hover:bg-white items-center" to='https://www.linkedin.com/company/mathematics-and-computing/' target='_blank' rel="noreferrer"><span className='bg-transparent'>LinkedIn</span>
