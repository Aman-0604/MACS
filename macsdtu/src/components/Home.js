    ...
    <>
      ...
      <div className="join-page w-full">
        ...
        <div className="gallery-grid columns-1 md:columns-2 lg:columns-3 xl:columns-3 mx-14 mt-10 mb-10">
          ...
          <MessageBox img={Shrey} name={"Shrey Singh"} role={"Former-Head of Research, MACS"} message={`"MACS seniors have answered my "bhaiya help chahiye/ bhaiya notes/ bhaiya subject konsa lu/ bhaiya coding kaha se karu and many more" questions everytime."`} />
        </div>
      </div>
